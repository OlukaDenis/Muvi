...
public class NowPlayingMoviesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        playing_recycleview = view.findViewById(R.id.recycler_view_all_playing);

        gridLayoutManager = new GridLayoutManager(getContext(), 3);
        gridLayoutManager.setSpanCount(3);
        playing_recycleview.setLayoutManager(gridLayoutManager);
        playing_recycleview.setHasFixedSize(true);
    ...
    private void loadMoreMovies(int pages) {
        apiService.getPlayingMovies(API_KEY, pages).enqueue(new Callback<MovieResponse>() {
            @Override
            public void onResponse(Call<MovieResponse> call, Response<MovieResponse> response) {
